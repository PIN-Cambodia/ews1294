...
class sensorLogChartCtrl extends Controller
{
    ...
    public function createChart()
    {
        ...
        else
        {
            ...
            $sensorlogs = DB::table('sensorlogs')
                ->select(DB::raw("id, date_format(date(date_sub(timestamp,interval 0 hour)),GET_FORMAT(DATE,'H:i:s')) as time, stream_height"))
                ->where('sensor_id','=',$sensor_id)->orderBy('time')->limit(24)->get();
        }
