...
class SensorTriggerController extends Controller
{
    ...
    public function getEditSensorTrigger(Request $request)
    {
        ...
        $commune_checkbox=""; $prov_options=""; $dis_options="";
        ...
        $modal_body = "<div class='modal-body'>"
            ...
            . "<div class='row'>"
            . "<div class='col-lg-3'>"
            . "<select class='fullwidth select_style' id='ss_province_1'>"
            . $prov_options
            . $other_prov_options
            . "</select>"
            . "</div>"
            . "<div class='col-lg-3'>"
            . "<select class='fullwidth select_style' id='ss_district_1'>"
            . $dis_options
            . $other_dis_options
            . "</select>"
            . "</div>"
            . "<div class='col-lg-6' id='ss_commune_div_1'>"
            . "<div class='row select_style_height'>"
            . "<div class='col-lg-12' id='ss_commune_1' name='ss_commune_1'>"
            . $commune_checkbox
            ...
            . "<script>
                     $(function() {
                        ...
                        $('#ss_province_1').change(function () {
                            ...
                            if(province_id !='')
                            {
                                $.ajax({
                                    ...
                                    {
                                        $('#ss_district_1').html(result).show();
                                    }
                                });
                            }
                            return false;
                        ...
                        $('#ss_district_1').change(function () {                        
                            $('option:selected', this).attr('selected',true).siblings().removeAttr('selected');
                            var distric_id = $('#ss_district_1').val();
                            if(distric_id != '')
                            {
                                $.ajax({
                                    type: 'POST',
                                    ...
                                    success: function(result)
                                    {
                                        $('#ss_commune_1').html(result);
                                        $('#ss_commune_div_1').show();
                                    }
                                });
                            }
                            return false;
    ...
    public function saveEditSensorTrigger(Request $request)
    {
        ...
        if ($request->hasFile('warning_sound_file')) {
            ...
            try{
                ...
                $this->logger->addError("Upload & Delete old sound file Error: " . $e->getMessage() . " in " . $e->getFile());
            }
        }
        ...
        try {
            ...
            $this->logger->addError("Update data Error: " . $e->getMessage() . " in " . $e->getFile());
        }
        return redirect()->intended('/sensortrigger');
    }
