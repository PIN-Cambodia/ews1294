      ...
      <a class="navbar-brand" href="{{ url('/') }}">
        <div class="row">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9">
              <h4 style="text-align: center; margin-left: 4%; font-size: 15px; font-family: Lato"><b>EARLY<br>WARNING<br> SYSTEM</b> 
              </h4>
              <h4 style="margin-left: 70%; margin-top: -32% ; position: absolute; font-size: 14px; text-align: center;" >
